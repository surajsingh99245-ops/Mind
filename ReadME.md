...
The goal of this project is to encourage self-reflection and help users better understand their emotional well-being over time. MindMate also visualizes mood trends, making it easier to notice patterns in daily life. If a journal entry contains signs of emotional crisis or self-harm, the application immediately displays supportive resources and flags the entry for additional safety handling.
...
> **Disclaimer:** MindMate is intended for self-reflection and wellness support. It is **not** a substitute for professional medical or mental health care.
